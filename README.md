# backstage/mkdocs-monorepo-wildcard-plugin

> **Note: This is a modified version of [backstage/mkdocs-monorepo-plugin](https://github.com/backstage/mkdocs-monorepo-plugin) with support for wildcard includes.
